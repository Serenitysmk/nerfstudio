...
@dataclass
class NerfactoLUT3DModelConfig(ModelConfig):
    """Nerfacto Model Config"""

    _target: Type = field(default_factory=lambda: NerfactoLUT3DModel)
...
class NerfactoLUT3DModel(Model):
    ...
    config: NerfactoLUT3DModelConfig
    ...
    def get_param_groups(self) -> Dict[str, List[Parameter]]:
        ...
        param_groups["fields"] = list(self.field.parameters()) + list(self.lut3d.parameters())
