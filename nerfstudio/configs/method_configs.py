...
from nerfstudio.models.nerfacto_unw import NerfactoUnwModelConfig
...
method_configs["nerfacto-unw"] = TrainerConfig(
    method_name="nerfacto-unw",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
    pipeline=VanillaPipelineConfig(
        ...
        model=NerfactoUnwModelConfig(eval_num_rays_per_chunk=1 << 15),
    ),
    optimizers={
        "proposal_networks": {
            "optimizer": AdamOptimizerConfig(lr=1e-2, eps=1e-15),
